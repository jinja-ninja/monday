...
export function Member({ boardMembers, task, boardId, groupId }) {
    ...
    // useEffect(() => {
    //     console.log('task.memberIds in use effect:', task.memberIds)
    //     setChosenMembers(...chosenMembers, task.memberIds)
    //     console.log('chosenMembers in use effect:', chosenMembers)
    //     console.log('boardMembers in use effect:', boardMembers)
    //     setSuggestedMembers(boardMembers.filter(member => !chosenMembers.includes(member._id)))
    //     // console.log('suMembers after update:', chosenMembers)
    //     console.log('suggestedMembers in use effect:', suggestedMembers)
    // }, [task.memberIds])
