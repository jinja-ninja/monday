        ...
        <div className={"side-bar-container " + dynOpenCloseClass}>
            ...
            <div className="side-bar-lower-container">
                ...
                <div className="workspace-container">
                    ...
                    <MenuButton closeDialogOnContentClick className="workspace-menu-btn" size={MenuButton.sizes.S}>
                        <Menu id="menu" size={Menu.sizes.MEDIUM}>
                            <MenuItem onClick={() => setIsFavorites('favorites')} icon={Favorite} iconType={MenuItem.iconType.SVG} title="Favorites" />
                            <MenuItem onClick={() => setIsFavorites('main')} icon={Work} iconType={MenuItem.iconType.SVG} title="Main workspace" />
                        </Menu>
                    </MenuButton>
                ...
                <div className="boards-btns-container">
                    {boards && getBoardsToShow().map((board, idx) => {
                        return (
                            <BoardNavLink
