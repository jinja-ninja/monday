...
export function BoardDetailsHeader({ setContent, title, boardId, setIsBoardDesc, isStarred }) {
    ...
    const dynStarIcon = isStarred ?
        <Tooltip
            ...
            <span onClick={() => toggleBoardFavorite(boardId, true)} className="star-icon-container">
        ...
        <IconButton
            ...
            onClick={() => toggleBoardFavorite(boardId, true)}
        />
                ...
                <div className="board-title">
                    ...
                    {isCollapse && <div className="left-btns">
                        ...
                        <Button
                            ...
                            kind="tertiary"
                            leftIcon={Invite}
                            onClick={() => (setIsShowInviteMembersModal(true))}
                            size="small"
                        >
                            Invite / 3
                        </Button>
